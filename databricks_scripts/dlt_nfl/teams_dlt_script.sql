...
AS 
SELECT * EXCEPT(processing_time)
FROM live.silver_teams
--FILTERING TO CURRENT_TEAMS
...
-- MAGIC ###### CONFIRMED THAT A DIFFERENT DLT PIPELINE CAN INGEST A DLT MATERIALIZED VIEW SO BELOW TABLE ISN"T NECESSARY
-- MAGIC ###### HOWEVER IF I DELETE THIS PIPELINE THE VIEW GOES AWAY 
-- MAGIC
